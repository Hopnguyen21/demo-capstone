...
namespace SmartFarm.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925081323_UsePostGisBoundaries")]
    partial class UsePostGisBoundaries
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SmartFarm.Domain.Entities.Field", b =>
                {
                    ...
                    b.Property<Polygon>("BoundaryGeoJson")
                    ...
                    b.HasIndex("BoundaryGeoJson")
                        .HasDatabaseName("ix_fields_boundary_gist");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("BoundaryGeoJson"), "gist");
                    ...
                    b.ToTable("fields", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_fields_boundary_valid", "boundary IS NULL OR ST_IsValid(boundary)");
            ...
            modelBuilder.Entity("SmartFarm.Domain.Entities.Zone", b =>
                {
                    ...
                    b.HasIndex("BoundaryGeoJson")
                        .HasDatabaseName("ix_zones_boundary_gist");
                    ...
                    b.ToTable("zones", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_zones_boundary_valid", "boundary IS NULL OR ST_IsValid(boundary)");
                        });
                });
