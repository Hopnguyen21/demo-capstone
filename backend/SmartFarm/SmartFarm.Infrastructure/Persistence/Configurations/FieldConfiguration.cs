...
internal sealed class FieldConfiguration : IEntityTypeConfiguration<Field>
{
    public void Configure(EntityTypeBuilder<Field> builder)
    {
        builder.ToTable("fields", table =>
        {
            ...
            table.HasCheckConstraint("ck_fields_boundary_valid", "boundary IS NULL OR ST_IsValid(boundary)");
        });
        ...
        builder.HasIndex(x => x.BoundaryGeoJson).HasDatabaseName("ix_fields_boundary_gist").HasMethod("gist");
